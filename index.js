(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(" \033[1;32m[<<===========â—€ï¸â”â”â€¢ð–£âœ¿âŠ± \033[1;33mOWNER \033[1;32mBROKEN \033[1;33mWASU \033[1;32mâŠ°âœ¿ð–£â€¢â”â”â–¶ï¸=========>>]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          console.log(" \033[1;32m[<<===============â—€ï¸â”â”â€¢ð–£âœ¿âŠ±OWNER MR WASUâŠ°âœ¿ð–£â€¢â”â”â–¶ï¸==============>>]");
          console.log('');
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.link/dzu11w=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
